...
cada uno con su porcentaje. Recibes SOLO esos dos insumos; no opinas sobre
reglas, ML ni documentos.
...
confianza (alta/media/baja) y citas (IDs de casos similares con su % de
similitud como evidencia).
