...
El sistema de puntuación de posible fraude opera en **dos capas independientes** que se muestran al analista por separado:
...
2. **Capa de IA (V4 + V5)** — un clasificador supervisado y un detector de anomalías que enriquecen la respuesta sin modificar el score de reglas (ver §6 del spec del reto, "Explicabilidad y Ética" — 25% del puntaje).
